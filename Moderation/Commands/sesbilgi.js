...
if(!member) return message.channel.send(nembed.setDescription(`Lütfen geçerli bir kullanıcı belirtin.`))
if(!member.voice.channel) return message.channel.send(nembed.setDescription(`Belirtilen kullanıcı herhangi bir ses kanalında bulunmamakta.`))
